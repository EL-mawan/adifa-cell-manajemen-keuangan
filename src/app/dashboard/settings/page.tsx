...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 lg:space-y-8 pb-32 lg:pb-8">
      {/* Header Section - More compact on mobile */}
      <div className="flex flex-col gap-1 lg:gap-2 px-1 lg:px-0">
          ...
          >
            {activeTab === 'profile' && (
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-white dark:bg-zinc-900 overflow-hidden outline outline-zinc-100 dark:outline-zinc-800">
                ...
                <CardContent className="p-6 lg:p-8 pt-0 space-y-6 lg:space-y-8">
                  <div className="flex flex-col sm:flex-row gap-6 lg:gap-8 items-center lg:items-start py-6 lg:py-8 border-b border-zinc-50 dark:border-zinc-800">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 lg:gap-6">
                    <div className="space-y-1.5 lg:space-y-2">
                      ...
                      <Input defaultValue={user?.name} className="rounded-2xl h-11 lg:h-12 border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950 focus:ring-2 focus:ring-indigo-500 transition-all font-bold" />
                    </div>
                    <div className="space-y-1.5 lg:space-y-2">
                      ...
                      <Input defaultValue={user?.email} disabled className="rounded-2xl h-11 lg:h-12 border-zinc-100 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-800 opacity-60 font-bold" />
                    </div>
                    <div className="space-y-1.5 lg:space-y-2">
                      ...
                      <Input placeholder="0812xxxx" className="rounded-2xl h-11 lg:h-12 border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950 focus:ring-2 focus:ring-indigo-500 transition-all font-bold" />
                    </div>
                    <div className="space-y-1.5 lg:space-y-2">
                      ...
                      <Input placeholder="Pilih Provinsi" className="rounded-2xl h-11 lg:h-12 border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950 focus:ring-2 focus:ring-indigo-500 transition-all font-bold" />
                    </div>
                  </div>

                  <div className="pt-4 lg:pt-6">
                    <Button onClick={handleSave} className="w-full h-11 lg:h-12 rounded-2xl bg-indigo-600 hover:bg-indigo-700 font-black gap-2 shadow-lg shadow-indigo-100 dark:shadow-none transition-all active:scale-[0.98]">
            ...
            {activeTab === 'security' && (
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-white dark:bg-zinc-900 overflow-hidden outline outline-zinc-100 dark:outline-zinc-800">
                ...
                <CardContent className="p-6 lg:p-8 pt-0 space-y-6 lg:space-y-8">
                  ...
                  <div className="pt-4 lg:pt-6">
                    <Button onClick={handleSave} className="w-full lg:w-auto h-11 lg:h-12 px-10 rounded-2xl bg-zinc-900 dark:bg-zinc-50 dark:text-zinc-900 hover:bg-zinc-800 font-black transition-all active:scale-[0.98]">
                      Perbarui Password
                    </Button>
                  </div>
                </CardContent>
            ...
            {activeTab === 'appearance' && (
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-white dark:bg-zinc-900 overflow-hidden outline outline-zinc-100 dark:outline-zinc-800">
                ...
                <CardContent className="p-6 lg:p-8 pt-0 space-y-8">
                ...
                <CardContent className="p-6 lg:p-8 pt-0 space-y-6 lg:space-y-8">
                  <div className="grid gap-4 lg:gap-6">
                    <div className="space-y-1.5 lg:space-y-2">
                      ...
                      <Input placeholder="ADIFA CELL" className="rounded-2xl h-11 lg:h-12 border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950 font-bold" />
                    </div>
                    <div className="space-y-1.5 lg:space-y-2">
                      ...
                      <Input placeholder="Jl. Raya Utama No. 123..." className="rounded-2xl h-11 lg:h-12 border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950 font-bold" />
                    </div>
                    <div className="grid grid-cols-2 gap-4 lg:gap-6">
                      <div className="space-y-1.5 lg:space-y-2">
                        ...
                        <Input placeholder="Kota" className="rounded-2xl h-11 lg:h-12 border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950 font-bold" />
                      </div>
                      <div className="space-y-1.5 lg:space-y-2">
                        ...
                        <Input placeholder="12345" className="rounded-2xl h-11 lg:h-12 border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950 font-bold" />
                      </div>
                    </div>
                  </div>
                  <div className="pt-4 lg:pt-6">
                    <Button onClick={handleSave} className="w-full h-11 lg:h-12 rounded-2xl bg-indigo-600 hover:bg-indigo-700 font-black shadow-lg shadow-indigo-100 dark:shadow-none transition-all active:scale-[0.98]">
                      Simpan Data Toko
                    </Button>
                  </div>
                </CardContent>
